...
int test_anon_map_readwrite() {
  ...
  *((unsigned char*)map) = 1;
  ...
  if (result != 0) printf("munmap (MAP_ANONYMOUS, PROT_READ | PROT_WRITE) returned unexpected error: %d\n", errno);
...
int test_anon_map_readonly() {
  ...
  *((unsigned char*)map) = 1;
  ...
  if (result != 0) printf("munmap (MAP_ANONYMOUS, PROT_READ) returned unexpected error: %d\n", errno);
...
int test_anon_map_writeonly() {
  ...
  *((unsigned char*)map) = 1;
  ...
  if (result != 0) printf("munmap (MAP_ANONYMOUS, PROT_WRITE) returned unexpected error: %d\n", errno);
...
int test_file_map_readwrite() {
  ...
  *((unsigned char*)map) = 1;
  ...
  if (result != 0) printf("munmap returned unexpected error: %d\n", errno);
